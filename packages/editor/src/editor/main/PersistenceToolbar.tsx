...
export const PersistenceToolbar = () => {
  ...
  useHotkeys(
    ...
    () => {
      setDetail(true);
      document.querySelector<HTMLElement>('.persistence-editor-detail-header')?.focus();
    },
    {
      scopes: ['global']
    }
  ...
  return (
    <Toolbar tabIndex={-1} ref={firstElement} className='persistence-editor-main-toolbar'>
      <ToolbarTitle className='persistence-editor-main-toolbar-title'>{t('title.main', { name: context.pmv })}</ToolbarTitle>
      <Flex gap={1}>
